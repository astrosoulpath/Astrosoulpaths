          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  'Serve  ÃƒÂ¢Ã…â€œÃ‚Â¦  Guide  ÃƒÂ¢Ã…â€œÃ‚Â¦  Grow',
                  style: TextStyle(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [
                      AppColors.gold.withValues(alpha: 0.23),
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: AppColors.gold.withValues(
            alpha: isAstrologerType ? 0.42 : 0.24,
          ),
        ),
        boxShadow: [
          BoxShadow(
                      ...
                      .map((value) {
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color: AppColors.gold.withValues(
                                alpha: isAstrologerType ? 0.40 : 0.28,
                              ),
                            ),
                          ),
                          child: Text(
            ...
            decoration: BoxDecoration(
              gradient: enabled
                  ...
                  : const LinearGradient(
                      colors: [Color(0xFF141414), Color(0xFF101010)],
                    ),
              borderRadius: BorderRadius.circular(20),
              border: Border.all(
                color: enabled
