  ...
  return (
    ...
    >
      <View style={{ paddingTop: 24, paddingBottom: 24 }}>
        ...
        >
          {isAstrologerAccepted ? "Talk to Astrologer" : "Calling Astrologer"}
        </Text>
        <Text
          style={{
        ...
        >
          The user has already joined the ZEGO room. This screen shows the ZIM
          invitation state and the live ZEGO audio state in one place.
        </Text>
      </View>
      ...
      >
        ...
        <View style={{ marginTop: 12 }}>
          ...
          <InfoRow label="Invitation" value={invitationState} />
          <InfoRow label="Call ID" value={callID ?? "Not created yet"} />
        ...
        <View style={{ marginTop: 12, gap: 10 }}>
          {remoteStreams.length === 0 ? (
            <Text style={{ color: "rgba(214,215,236,0.62)", fontSize: 13 }}>
              No astrologer stream is playing yet. This is expected while the
              astrologer is still accepting or has not started publishing.
            </Text>
          ) : (
