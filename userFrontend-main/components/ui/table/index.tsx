...
type ITableProps =
  React.ComponentProps<typeof ExpoTable>;

type ITableHeaderProps =
  React.ComponentProps<typeof ExpoTHead>;

type ITableBodyProps =
  React.ComponentProps<typeof ExpoTBody>;

type ITableFooterProps =
  React.ComponentProps<typeof ExpoTFoot>;

type ITableRowProps =
  React.ComponentProps<typeof ExpoTR>;

type ITableCaptionProps =
  React.ComponentProps<typeof ExpoTCaption>;

type TableHeadViewProps =
  ViewProps & {
    useRNView: true;
    className?: string;
  };
...
const TableHead =
  ...
  >(function TableHead(
    ...
    if (props.useRNView === true) {
      const {
        useRNView: _useRNView,
        className,
        ...viewProps
      } = props;
      ...
      return (
        <View
          ref={
            ref as React.ForwardedRef<View>
          }
    ...
    return (
      <Text
        ref={
          ref as React.ForwardedRef<Text>
        }
        className={tableHeadStyle({
          class: className,
        })}
