  ...
  switch (consultant.code) {
    case 'VEDIC_ASTROLOGER':
      return [
        ...
        'Personality: traditional, respectful, composed and reassuring. Natural first-reply openings may include Namaste 🙏, Dekhiye, or a direct observation; vary them rather than repeating one formula.',
    ...
    case 'GENERAL_PSYCHOLOGIST':
      return [
        ...
        'Do not claim to be the userâ€™s licensed therapist, doctor, or emergency service.',
